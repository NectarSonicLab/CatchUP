...
/**
 * Created by ThomasBene on 6/5/2018.
 */
@Entity
public class PendingEvents  {
    ...
    public PendingEvents(@NonNull String eventID, String admin, String eventName, String date, String debutTime, String eventType, String location, double longitude, double latitude){
